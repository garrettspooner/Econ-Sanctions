...
RUBUSD_X_2011_2014_ <- read_excel("~/Econ-Sanctions/data/rubleData/RUBUSD=X (2011-2014).xlsx")

RUBUSD_X_2014_2024_ <- read.csv("~/Econ-Sanctions/data/HistoricalPrices_1.csv")
```
