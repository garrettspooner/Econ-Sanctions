...
#Tidyquant combines the functionality of many packages, including quantmod, PerformanceAnalytics, zoo, xts, and TTR.
...
```{r}
#Package 4: Quandl supports both time-series data and datatables. 
